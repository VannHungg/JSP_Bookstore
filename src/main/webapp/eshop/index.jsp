...
<html lang="en">	
<%
//làm trang hiển thị đk thành công, sau đó điều hướng quay về trang index
%>
<head>
    <meta charset="utf-8">
    ...
    <link href="<%=url %>/eshop/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        %>
	                        <div class="navbar-nav ml-auto py-0">
	                            <a href="<%= url %>/eshop/login/signin.jsp" class="nav-item nav-link">Sign In</a>
	                            <a href="<%= url %>/eshop/login/signup.jsp" class="nav-item nav-link">Sign Up</a>
	                        </div>
	                    <% } else {%>
		                    <div class="navbar-nav ml-auto py-0">
		                    	<div class="nav-item dropdown">
	                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Xin chào <%=khachHang.getTenDangNhap() %></a>
	                                <div class="dropdown-menu rounded-0 m-0">
