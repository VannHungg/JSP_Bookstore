            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="<%=url %>/eshop/login/signup.jsp" class="signup-image-link">Create an account</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" action="<%=url %>/sign-in" class="register-form" id="login-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="your_name" id="your_name" placeholder="Your Name" <%if(error != null) { %>value="<%=username%>"<%} %>/>
                            </div>
                            <div class="form-group">
